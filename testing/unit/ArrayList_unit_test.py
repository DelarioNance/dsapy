...
from helpers import rand_array_list, ndarray_of_first_ints
...
class TestPrinting:
    def test_print_empty_ArrayList(self, capsys):
        ...
        output_from_empty_arraylist = capsys.readouterr()[0]
    ...
    def test_print_ArrayList_of_one_int(self, capsys):
        ...
        output_from_arraylist_of_one_int = capsys.readouterr()[0]
    ...
    def test_print_ArrayList_of_ten_ints(self, capsys):
        ...
        output_from_arraylist_of_ten_ints = capsys.readouterr()[0]
    ...
    def test_print_ArrayList_of_one_hundred_ints(self, capsys):
        ...
        output_from_arraylist_of_one_hundred_ints = capsys.readouterr()[0]
    ...
    def test_print_ArrayList_of_ten_thousand_ints(self, capsys):
        ...
        output_from_arraylist_of_ten_thousand_ints = capsys.readouterr()[0]
