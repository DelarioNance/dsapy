...
class TestAppendingValueWithoutError:
    @pytest.mark.parametrize("num_of_ints", [
        pytest.param(0, id="zero ints"),
        pytest.param(CAPACITY_MULTIPLE*(2**0)-1, id="one-from-full list of default_capacity*(2^0)-1"),
        pytest.param(CAPACITY_MULTIPLE*(2**2)-1, id="one-from-full list of default_capacity*(2^2)-1"),
        pytest.param(CAPACITY_MULTIPLE*(2**4)-1, id="one-from-full list of default_capacity*(2^4)-1"),
        pytest.param(CAPACITY_MULTIPLE*(2**6)-1, id="one-from-full list of default_capacity*(2^6)-1"),
        pytest.param(CAPACITY_MULTIPLE*(2**8)-1, id="one-from-full list of default_capacity*(2^8)-1"),
        pytest.param(CAPACITY_MULTIPLE*(2**10)-1, id="one-from-full list of default_capacity*(2^10)-1"),
        pytest.param(CAPACITY_MULTIPLE*(2**0), id="full list of default_capacity*(2^0)"),
        pytest.param(CAPACITY_MULTIPLE*(2**2), id="full list of default_capacity*(2^2)"),
        pytest.param(CAPACITY_MULTIPLE*(2**4), id="full list of default_capacity*(2^4)"),
        pytest.param(CAPACITY_MULTIPLE*(2**6), id="full list of default_capacity*(2^6)"),
        pytest.param(CAPACITY_MULTIPLE*(2**8), id="full list of default_capacity*(2^8)"),
        pytest.param(CAPACITY_MULTIPLE*(2**10), id="full list of default_capacity*(2^10)"),
        pytest.param(CAPACITY_MULTIPLE*(2**10), id="full list of default_capacity*(2^10) ints"),
        pytest.param(CAPACITY_MULTIPLE*(2**0) + 1, id="one-past-full list of default_capacity*(2^0)+1 ints"),
        pytest.param(CAPACITY_MULTIPLE*(2**2) + 1, id="one-past-full list of default_capacity*(2^2)+1 ints"),
        pytest.param(CAPACITY_MULTIPLE*(2**4) + 1, id="one-past-full list of default_capacity*(2^4)+1 ints"),
        pytest.param(CAPACITY_MULTIPLE*(2**6) + 1, id="one-past-full list of default_capacity*(2^6)+1 ints"),
        pytest.param(CAPACITY_MULTIPLE*(2**8) + 1, id="one-past-full list of default_capacity*(2^8)+1 ints"),
        pytest.param(CAPACITY_MULTIPLE*(2**10) + 1, id="one-past-full list of default_capacity*(2^10)+1 ints"),
    ])
...
class TestRemovingValueWithoutError:
    class TestRemovingStartValueWithoutError:
        @pytest.mark.parametrize("num_of_ints", [
            ...
            pytest.param(CAPACITY_MULTIPLE*(2**0)-1, id="one-from-full list of default_capacity*(2^0)-1 ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**2)-1, id="one-from-full list of default_capacity*(2^2)-1 ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**4)-1, id="one-from-full list of default_capacity*(2^4)-1 ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**6)-1, id="one-from-full list of default_capacity*(2^6)-1 ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**8)-1, id="one-from-full list of default_capacity*(2^8)-1 ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**10)-1, id="one-from-full list of default_capacity*(2^10)-1 ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**0), id="full list of default_capacity*(2^0) ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**2), id="full list of default_capacity*(2^2) ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**4), id="full list of default_capacity*(2^4) ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**6), id="full list of default_capacity*(2^6) ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**8), id="full list of default_capacity*(2^8) ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**10), id="full list of default_capacity*(2^10) ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**0) + 1, id="one-past-full list of default_capacity*(2^0)+1 ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**2) + 1, id="one-past-full list of default_capacity*(2^2)+1 ints"),
            pytest.param(CAPACITY_MULTIPLE*(2**4) + 1, id="one-past-full list of default_capacity*(2^4)+1 ints"),
